...
public class StringCoach {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. '==' will compare address of 2 objects");
        ...
        System.out.println("2. 'equals' will compare value of 2 objects");
        ...
        System.out.println("3. Put String c into String Interning - String Pools and compare address with a again");
        c = c.intern();
